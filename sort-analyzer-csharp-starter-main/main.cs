    ...
    public static void Main(string[] args)
    {
        ...
        void Bubble (int[] anArray, String ArrayType)
        {
            ...
            for (int i = 0; i < 50; i++)
            {
             ...
             timer.Stop();
             Console.WriteLine($"Bubble Sort {ArrayType}: {timer.Elapsed / 50} AVG Time");
        }
        ...
        void Selection (int[] anArray, String ArrayType)
        {
            ...
            timer.Stop();
            Console.WriteLine($"Selection Sort {ArrayType}: {timer.Elapsed / 50} AVG Time");
        }
        ...
        void Insertion (int[] anArray, String ArrayType)
        {
            ...
            timer.Stop();
            Console.WriteLine($"Insertion Sort {ArrayType}: {timer.Elapsed/ 50} AVG Time");
        }
    }
